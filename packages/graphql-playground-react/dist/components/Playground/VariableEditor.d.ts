...
export declare const VariableEditorComponent: import("react-redux").ConnectedComponent<typeof VariableEditor, Pick<Props & ReduxProps, "getRef" | "prettifyQuery" | "onHintInformationRender" | "onRunQuery">>;
export declare const HeadersEditorComponent: import("react-redux").ConnectedComponent<typeof VariableEditor, Pick<Props & ReduxProps, "getRef" | "variableToType" | "prettifyQuery" | "onHintInformationRender" | "onRunQuery">>;
export {};
