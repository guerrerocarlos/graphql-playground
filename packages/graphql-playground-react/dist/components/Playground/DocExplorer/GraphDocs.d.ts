...
declare class GraphDocs extends React.Component<SideTabContentProps & StateFromProps & DispatchFromProps, State> {
    ...
    componentWillReceiveProps(nextProps: SideTabContentProps & StateFromProps): void;
...
declare const _default: import("react-redux").ConnectedComponent<typeof GraphDocs, Pick<SideTabContentProps & StateFromProps & DispatchFromProps, "ref" | "schema" | "sessionId" | "setWidth"> & SideTabContentProps>;
